...
<body class="hold-__ition login-page">
    @if (app()->getLocale() == 'ar')
  <h4><a href="set_lang/en" style="color: black;margin-left:10px;">
      English
      </a>
      @else
      <h4><a href="set_lang/ar" style="color: black;margin-left:10px;">
      Arabic
  @endif</a></h4>
...
<div class="login-box">
  ...
  <div class="login-box-body">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="remember" value="1"> {{ __('admin.Remember') }}
            </label>
          </div>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">{{ __('admin.sign_in') }}</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <a href="register.html" class="text-center">{{ __('admin.Register_new') }}</a>
